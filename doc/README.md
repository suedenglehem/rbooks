# library-rag — M0-era README (frozen)

_Frozen development artifact; see `../README.md` for the current state._

A local-first RAG research application for a large personal book library
(PDF + EPUB, ~300 GB and growing). See `project/CLAUDE_PRD.md` for the full
product specification.

## Status

M0 (environment, skeleton, `doctor`) is complete. See `project/PROGRESS.md`
for the milestone log. Full-library ingestion is intentionally not yet wired up and is
